...
queries = ["Number of employees left and retained by [ satisfaction scores ]",
           "Number of employees left and retained by [ last evaluation scores ]",
           "Number of employees left and retained by [ number of projects they participated ]",
           "Number of employees left and retained by [ average monthly hours they worked ]",
           "Number of employees left and retained by [ time of service in the company ]",
           "Number of employees left and retained by [ whether they had work acciden ]",
           "Number of employees left and retained by [ promotion they received in the last 5 years ]",
           "Number of employees left and retained by [ department they worked in ]", 
           "Number of employees left and retained by [ salary category ]"
           ]
...
st.success("Showing the visual for : **Count of employees left and retained by "+selected_column+ "**")
